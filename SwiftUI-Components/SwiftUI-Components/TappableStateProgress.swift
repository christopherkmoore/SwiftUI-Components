...
struct TappableStateProgress: View {
   ...
   enum Tracking: String, Identifiable {
   ...
   @State var stateTasksList = [
      StateTask(trackingBubble: .done, description: "Create Invoice"),
      StateTask(trackingBubble: .done, description: "Invoice Sent"),
      StateTask(trackingBubble: .inProgress, description: "Invoice Paid")
   ]
